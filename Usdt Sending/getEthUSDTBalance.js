...
const web3 = new Web3('https://eth-mainnet.g.alchemy.com/v2/RjSInvJc-YEUUH2M1_wevtj29b6WjO21');
...
async function getUSDTBalance() {
  const balanceRaw = await USDT_CONTRACT.methods.balanceOf(accountAddress).call();
